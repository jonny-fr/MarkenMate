...
export const Plasma = ({
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      const mouseUniform = (program.uniforms as any).uMouse.value;
    ...
    const setSize = () => {
      ...
      const res = (program.uniforms as any).iResolution.value;
    ...
    const loop = (t: number) => {
      ...
      (program.uniforms as any).iTime.value = timeValue;
