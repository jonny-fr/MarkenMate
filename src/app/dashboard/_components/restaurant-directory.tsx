...
export function RestaurantDirectory({
  ...
  return (
    <AuroraBackground className="rounded-lg">
      <Card id="restaurants" className="h-full border-none bg-transparent backdrop-blur-sm">
        <CardHeader>
          <CardTitle className="text-muted-foreground">Restaurants</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
          <div className="flex max-h-[420px] flex-col gap-3 overflow-y-auto pr-2">
            {restaurants.map((restaurant) => (
              <StarBorder key={restaurant.id} className="rounded-lg" color="rgba(168, 85, 247, 0.8)" speed="6s">
